...
// Language-specific TTS codes (some languages need different codes for TTS)
...
app.post('/api/translate', async (req, res) => {
  try {
    ...
    try {
      ...
      // Use TTS-specific language code if available
      const ttsLangCode = TTS_LANGUAGE_CODES[targetLanguage] || LANGUAGE_CODES[targetLanguage];
      const gtts = new gTTS(translatedText, ttsLangCode);
